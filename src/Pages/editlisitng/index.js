...
setselectedeminity(details.listingdetails.amenities.map((item)=>item.uuid))
}
...
const createlisting=()=>{
  ...
  formdata.append('latitude',locationstring===details.listingdetails.address?details.listingdetails.coordinates.latitude:location.latitude)
  formdata.append('longitude',locationstring===details.listingdetails.address?details.listingdetails.coordinates.longitude:location.longitude)
  formdata.append('zipcode',locationstring===details.listingdetails.address?details.listingdetails.zipcode:location.zipcode)
  formdata.append('address',locationstring)
  formdata.append('guestLimit',JSON.stringify(data.guestLimit))
  formdata.append('timezone',locationstring===details.listingdetails.address?details.listingdetails.timezone:location.timezone.id)
          ...
          <form>
            <div className="row mrg-r-10 mrg-l-10">
              ...
              <div className="col-sm-6">
                ...
                <select data-placeholder="Choose Category" readOnly
...
:'loading'
              ...
              <div className="col-sm-6">
                <label>Slots</label>
                <input disabled={!selectedcategory?.slots} type="number" className="form-control" readOnly
        ...
        <div className="add-listing-box full-detail mrg-bot-25 padd-bot-30 padd-top-25">
          ...
          <div className="row mrg-r-10 mrg-l-10">
            <div className="col-sm-12">
              ...
              <textarea className="h-500 form-control" defaultValue={""}  value={data.discription}
