...
return (
    ...
    <section className="padd-0" style={{marginTop:'150px'}}>
      <Enterotp show={show} close={onclose} type={type} userid={user.user?.user?.uuid} />
...
<div className="listing-box-header">
          ...
          <div className="listing-box-header">
            ...
            <p style={{fontSize:10,fontWeight:"bold",marginTop:5,color:'blue',cursor: 'pointer'}}
             onClick={()=>{setbaseurl("")}}
            >Remove  Image</p>
          </div>
          <form>
            ...
            <div className="col-sm-6">
              ...
              <div style={{display: 'flex',alignItems:'center'}}>
                ...
                onClick={()=>{setshow(true);settype(1)}}
                >Verify</Button>
}
                </div>
              ...
              <div className="col-sm-6">
                ...
                alt="verified"/>:
                <Button  variant="outline-primary" style={{width:'150px',height:'40px',marginLeft:'5px'}}
                onClick={()=>{setshow(true);settype(2)}}
                >Verify</Button>
}
                </div>
              </div>
          ...
          <Button style={{maxWidth:'50%',backgroundColor:'#1effac',border:'none',color:'white',marginTop:'20px'}} 
           title="Submit Listing" onClick={updateprivacysettingslocal}>Update Privacy Settings</Button>
        </div>
        </div>
