...
const LBModal = (props) => {
  ...
  const submit = () => {
    if (slot?.length > 0) {
      ...
      if (props.edit) {
        dispatch(Updateblock(props.id, props.bid, finalobject));
      } else {
