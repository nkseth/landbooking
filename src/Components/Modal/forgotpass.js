...
import {opensnackbar, phoneandemailv, validate,} from '../../redux/slices/user'
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
        <div style={{width:'100%',display: 'flex',justifyContent: 'space-evenly',alignItems:"center",flexDirection: 'column'}}>
        <div className="my-2">
   ...
   {resendopt? <Button style={{marginTop:50}} onClick={()=>{ validateotp();setotp("")
      }}>Verify</Button>:null}
         ...
         color:'white',border:'none'}} onClick={()=>{ 
           if(enterusername!=="" && (newpassword!=="" && newpassword.length>6)){
            ...
            setotp("");setresendotp(true)
             ...
             dispatch(opensnackbar("error","Please Enter Proper Details to continue"))
           }
